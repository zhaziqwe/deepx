#ifndef DEEPX_TENSORFUNC_ELEMENTWISE_MIAO_BYTE_BASIC_CU
#define DEEPX_TENSORFUNC_ELEMENTWISE_MIAO_BYTE_BASIC_CU
...
#endif // DEEPX_TENSORFUNC_ELEMENTWISE_MIAO_BYTE_BASIC_CU
