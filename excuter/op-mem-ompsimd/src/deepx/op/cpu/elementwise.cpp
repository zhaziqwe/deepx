...
namespace deepx::op::cpu{
     ...
     void addInPlace(Tensor<float> &tensor,const Tensor<float> &other){
    ...
    Tensor<float> add(const Tensor<float> &tensor,const Tensor<float> &other){
        Tensor<float> result=op::cpu::clone(tensor);
        addInPlace(result,other);
        return result;
    }
    Tensor<float> add(const Tensor<float> &tensor,const float value){
        Tensor<float> result=op::cpu::clone(tensor);
        addInPlace(result,value);
        return result;
    }
