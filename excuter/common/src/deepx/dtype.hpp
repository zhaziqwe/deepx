...
inline std::string precision_str(Precision p) {
    ...
    if (value & static_cast<uint16_t>(Precision::Float64)) types.push_back("float64");
    if (value & static_cast<uint16_t>(Precision::Float32)) types.push_back("float32");
    if (value & static_cast<uint16_t>(Precision::Float16)) types.push_back("float16");  // 改回float16
    if (value & static_cast<uint16_t>(Precision::BFloat16)) types.push_back("bfloat16"); // 改回bfloat16
    if (value & static_cast<uint16_t>(Precision::Float8E5M2)) types.push_back("float8e5m2");
    if (value & static_cast<uint16_t>(Precision::Float8E4M3)) types.push_back("float8e4m3");
    if (value & static_cast<uint16_t>(Precision::Float4E2M1)) types.push_back("float4e2m1");
    if (value & static_cast<uint16_t>(Precision::Int64)) types.push_back("int64");
    if (value & static_cast<uint16_t>(Precision::Int32)) types.push_back("int32");
    if (value & static_cast<uint16_t>(Precision::Int16)) types.push_back("int16");
...
inline Precision precision(const std::string& str) {
    if (str == "any") return Precision::Any;
    else if (str == "float64") return Precision::Float64;
    ...
    else if (str == "float8e5m2") return Precision::Float8E5M2;
    else if (str == "float8e4m3") return Precision::Float8E4M3;
    else if (str == "float4e2m1") return Precision::Float4E2M1;
    
    // 添加组合类型支持
    else if (str == "int") return Precision::Int;
    else if (str == "float") return Precision::Float;
